...
**Tests**: The examples below include test tasks. Per project constitution Principle IV, tests are **MANDATORY** for all new features and bug fixes. A test suite MUST be included in every implementation.
