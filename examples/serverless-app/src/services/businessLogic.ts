/**
 * Business logic layer for the Serverless application
 * Handles data operations and business rules for Lambda functions
 */
...
const users: User[] = [
    { id: 1, email: 'alice@example.com', name: 'Alice Smith', role: 'admin', createdAt: new Date().toISOString() },
    { id: 2, email: 'bob@example.com', name: 'Bob Johnson', role: 'user', createdAt: new Date().toISOString() },
    { id: 3, email: 'charlie@example.com', name: 'Charlie Brown', role: 'user', createdAt: new Date().toISOString() },
];

const products: Product[] = [
    { id: 1, name: 'Laptop', price: 999, category: 'Electronics', description: 'High-performance laptop', inStock: true },
    ...
    { id: 5, name: 'Desk', price: 199, category: 'Furniture', inStock: true },
];
